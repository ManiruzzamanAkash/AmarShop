          ...
          <form action="{{ route('product.create') }}" method="POST" enctype="multipart/form-data">
            ...
            <section class="p-l-10 p-r-10 p-t-10 p-b-10">
              ...
              <b-field label="Product Title">
                <b-input name="title" required maxlength="150" value="{{ $product->title }}"></b-input>
              </b-field>
              ...
              <b-field grouped>
                <b-field label="Product Price">
                  ...
                  <b-field>
                    ...
                    <b-input type="number" name="price" required min=0  value="{{ $product->price }}"></b-input>
                  </b-field>
                </b-field>
                ...
                <b-field label="Division">
                  ...
                  <select  name="division" class="input" required>
                    @foreach ($divisions as $division)
                ...
                <b-field label="Protuct Type">
                  <select name="status" class="input" required>
                    ...
                    <option value="2" {{ ($product->status == 2) ? 'selected' : '' }}>New</option>
                    <option value="1" {{ ($product->status == 1) ? 'selected' : '' }}>Old</option>
                  </select>
                </b-field>
              ...
              {{-- <b-field label="Product Featured Image">

              <b-input type="file" class="is-left" name="image" required></b-input>
              <b-input type="file" class="" name="image" required></b-input>
              <b-input type="file" class="" name="image" required></b-input>

              <button @click="addNewImageField" type="button" class="m-l-10  button is-info is-right"><i class="fa fa-plus"></i></button> <br />
            </b-field> --}}

            <b-collapse :open="false">
              <button class="button is-info m-t-10 m-b-10 is-pulled-right" slot="trigger" type="button"> <i class="fa fa-plus"></i> Add Offer For Fast Buyers between expiry date (Optional)</button>
